...
contract TruSale is Ownable, Haltable {
    ...
    */
    ...
    function TruSale(uint256 _startTime, uint256 _endTime, address _token) public {
        ...
        // remove 1 wei from Minimum Amount to actually make it the bare reject amount
        minimumAmount = minimumAmount.sub(1);
    ...
    function buyTruTokens(address _purchaser) public stopInEmergency payable {
    ...
    function updateWhitelist(address _purchaser, bool _status) public onlyOwner {
